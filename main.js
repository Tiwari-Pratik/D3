...
filterOdd.addEventListener('click', function(event){
  ...
  selectedBtn.textContent = selectionText;
  const allOddChildSelectedSvg = d3.selectAll('.project svg').selectChildren().filter(':nth-of-type(odd)');
...
filterEven.addEventListener('click', function(event){
  ...
  selectedBtn.textContent = selectionText;
  const allEvenChildSelectedSvg = d3.selectAll('.project svg').selectChildren().filter(':nth-of-type(even)');
  // console.log({allOddChildSelectedSvg});
